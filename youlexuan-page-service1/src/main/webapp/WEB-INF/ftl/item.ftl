...
<body ng-app="youlexuan" ng-controller="itemController" ng-init="loadSku()">

<#assign imageList=goodsDesc.itemImages?eval />
<#assign specList=goodsDesc.specificationItems?eval />
<#assign customItems=goodsDesc.customAttributeItems?eval />
		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					<li>
						<a href="#">${catagory1Name}</a>
					</li>
					<li>
						<a href="#">${catagory2Name}</a>
					</li>
					<li>
						<a href="#">${catagory3Name}</a>
					</li>
				</ul>
			</div>
			<!--product-info-->
							...
							<#list specList as spec>
							    <dl>
									...
									<#list spec.attributeValue as option>
									    <dd><a class="{{checkOptionIsSelect('${spec.attributeName}','${option}')?'selected':''}}" ng-click="addSpecOption('${spec.attributeName}','${option}')" >${option} </a></dd>
									</#list>
                                </dl>
							</#list>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
                                        <a ng-click="addCart()" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
